...
public enum ErrorCode {
    ...
    TURING_ACCOUNT_CERTIFICATION(ErrorConstants.ACCOUNT_CERTIFICATION, "认证信息过期或无权限！",
        "Authentication information expired or no permissions!"),
    TURING_ACCOUNT_NOT_ALLOW(ErrorConstants.NOT_ALLOW, "账号不存在或密码不正确！",
        "Account does not exist or password is incorrect!"),
    TURING_ACCOUNT_STATUS(ErrorConstants.ACCOUNT_STATUS, "账号状态为 {}，禁止使用！",
        "Account status is {}, prohibited from use!"),
    TURING_ACCOUNT_PASSWORD_INCORRECT(ErrorConstants.PASSWORD_INCORRECT, "密码不正确！", "Password is incorrect!"),
    TURING_VALIDATE_PASSWORD(ValicationConstants.VALIDATE_PASSWORD, "{} 密码格式错误，包含大小写字母、数字和_-.?;,!@#特殊字符，且在8到20位之间！",
    ...
    VALIDATE_USERNAME(ValicationConstants.VALIDATE_USERNAME, "{} 用户名格式错误，大小写字母开头，包含大小写字母、数字和_-特殊字符，且在4到200位之间！",
